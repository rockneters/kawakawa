...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/tambah/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/hapus/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
