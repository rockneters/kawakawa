...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/tambah/addss.sh"
wget -O delss "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/hapus/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/${GitUser}/kawakawa/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
